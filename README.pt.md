...
📖 **[Detalhamento completo →](docs/FEATURES.pt.md)**
...
📖 **[Detalhamento completo →](docs/FEATURES.pt.md#-coleta-de-dados)**
...
📖 **[Detalhamento completo →](docs/TECH_STACK.pt.md)**
...
│
├── docs/                      # Documentação
│   ├── FUNCIONALIDADES.pt.md    # Detalhamento das features
│   ├── MODELO_DADOS.pt.md       # Schema explicado
│   ├── API.pt.md                # Rotas e endpoints
│   └── DECISOES.pt.md           # Por que cada tecnologia
│
└── README.pt.md                  # Visão geral (este arquivo)
```
---
...
📖 **[Detalhamento completo →](docs/ROADMAP.pt.md)**
...
📖 **[Detalhamento completo →](docs/DESIGN_SYSTEM.pt.md)**
...
| ----------------- | -------------------------- | ----------------------------- |
| Funcionalidades   | Especificação completa     | [Ver](docs/FEATURES.pt.md) |
| Design System     | Schema Prisma explicado    | [Ver](docs/DESIGN_SYSTEM.pt.md) |
| Stack Tecnológica | Por que cada tecnologia    | [Ver](docs/TECH_STACK.pt.md) |
| Roadmap           | Roadmap de desenvolvimento | [Ver](docs/ROADMAP.pt.md) |
